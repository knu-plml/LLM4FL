...
if __name__ == '__main__':
    ...
    for i in range(5):
        fine_tune(
            training_file, validation_file, epochs=1, batch_size=batch_size, save_dir='../../models/noSequence-finetuned-model/'+model_name+'-finetune/' + str(i) + '/', parallel=True, load_range=None
        )

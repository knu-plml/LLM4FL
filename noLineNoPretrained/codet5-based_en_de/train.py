...
if __name__ == '__main__':
    ...
    for i in range(5):
        fine_tune(
            training_file, validation_file, epochs=1, batch_size=10, save_dir='../../models/noLineNoPretrained-model/'+model_name+'-finetune/' + str(i) + '/', parallel=False, load_range=None
        )

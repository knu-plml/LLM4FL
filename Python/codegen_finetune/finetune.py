...
def fine_tune(training_file, epochs, batch_size, save_dir, parallel=False, load_range=None):
    ...
    dataset = Dataset(training_file, tokenizer, max_length=992, shuffle=False, load_range=[0, 120000])
...
if __name__ == '__main__':
    ...
    training_file = '../../data/codeNetPython.jsonl'      # change to fine-tuning data path
    ...
    fine_tune(
        training_file, epochs=1, batch_size=batch_size, save_dir='../../models/Python-finetuned-model/'+model_name+'-finetune/' + iterN + '/', parallel=parallel, load_range=None
    )

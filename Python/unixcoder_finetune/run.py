...
def main():
    ...
    if args.do_test:
        ...
        for j in range(5):
            model.load_state_dict(torch.load(args.load_model_path + '/' + str(args.seed) + '/pytorch_model.bin'))
            model.to(device_id)
            model.eval() 
            ...
            if not os.path.exists(args.output_dir):
                os.makedirs(args.output_dir)
            json.dump(unixcoder_output, open(args.output_dir + '/unixcoder_output' + str(args.seed) + '.json', 'w'), indent=2)

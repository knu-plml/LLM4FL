...
if __name__ == '__main__':
    model_names = ['codegen-350M', 'codegen-2B', 'codegen-6B']
    ...
    for model_name in model_names:
        ...
        fine_tune(
            training_file, validation_file, epochs=1, batch_size=batch_size, save_dir='../../models/noLineNum-finetuned-model/'+model_name+'-finetune/' + iterN + '/', parallel=parallel, load_range=None
        )

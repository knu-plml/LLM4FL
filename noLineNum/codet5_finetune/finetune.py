...
if __name__ == '__main__':
    model_names = ['codet5-small', 'codet5-base', 'codet5-large']
    ...
    for model_name in model_names:
        ...
        batch_size = 10
        if model_name == 'codet5-base':
            batch_size = 6
        elif model_name == 'codet5-large':
            batch_size = 2

        for i in range(5):
            fine_tune(
                training_file, validation_file, epochs=1, batch_size=batch_size, save_dir='../../models/noLineNum-finetuned-model/'+model_name+'-finetune/' + str(i) + '/', parallel=False, load_range=None
            )

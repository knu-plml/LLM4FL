...
if __name__ == '__main__':
    model_name = 'codegen-2B' # codegen-350M codegen-2B codegen-6B
    iterN = '0'
    ...
    fine_tune(
        training_file, validation_file, epochs=1, batch_size=batch_size, save_dir='../../models/Java-finetuned-model/'+model_name+'-finetune/' + iterN + '/', parallel=parallel, load_range=[0, 100]
    )

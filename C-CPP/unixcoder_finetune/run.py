...
def main():
    ...
    if args.do_test:
        ...
        for j in range(5):
            ...
            unixcoder_output = {'config': 'finetune', 'data': {}, 'model': 'unixcoder'}
            for i, eval_example in enumerate(eval_examples):
                ...
                unixcoder_output['data'][str(i)] = {}
                unixcoder_output['data'][str(i)]['output'] = output
                unixcoder_output['data'][str(i)]['input'] = eval_example.source
                unixcoder_output['data'][str(i)]['gold_output'] = eval_example.target

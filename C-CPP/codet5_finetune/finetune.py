...
def fine_tune(training_file, epochs, batch_size, save_dir, parallel=False, load_range=None):
    ...
    dataset = Dataset(training_file, tokenizer, max_length=480, shuffle=False, load_range=load_range)
...
if __name__ == '__main__':
    model_name = 'codet5-small' # 'codet5-small' # ['codet5-small', 'codet5-base', 'codet5-large']
    iterN = '0'
    ...
    fine_tune(
        training_file, epochs=1, batch_size=batch_size, save_dir='../../models/CandCP-finetuned-model/'+model_name+'-finetune/' + iterN + '/', parallel=False, load_range=None
    )

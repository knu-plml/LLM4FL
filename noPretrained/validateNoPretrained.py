...
def validate_python(input_file):
    ...
    #print('Top-5 :', tops[2])
    #print()
    validated_result['Top-1'] = tops[0]
    validated_result['Top-3'] = tops[1]
    validated_result['Top-5'] = tops[2]
...
if __name__ == '__main__':
    model_dirs = []
    models = ['codebert-based_en', 'codet5-based_en_de', 'codegen-based_de']
    benchmark = ['defects4j', 'humaneval', 'quixbugs']
    for data in benchmark:
        dataPrefixes = list(map(lambda x: './' + x + '/' + data + '_result/' + x.split('-based')[0], models))
        #print(dataPrefixes)

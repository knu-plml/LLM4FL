...
if __name__ == '__main__':
    ...
    fine_tune(
        training_file, validation_file, epochs=1, batch_size=batch_size, save_dir='../../models/noPretrained-finetuned-model/'+model_name+'-finetune/' + iterN + '/', parallel=parallel, load_range=None
    )
